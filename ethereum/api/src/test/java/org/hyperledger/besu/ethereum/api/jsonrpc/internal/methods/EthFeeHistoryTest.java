...
public class EthFeeHistoryTest {
  ...
  public void setUp() {
    ...
    when(miningCoordinator.getMinTransactionGasPrice()).thenReturn(Wei.ZERO);
    method =
        new EthFeeHistory(
            protocolSchedule,
            blockchain,
  ...
  public void shouldBoundRewardsCorrectly() {
    ...
    ApiConfiguration apiConfiguration =
        ImmutableApiConfiguration.builder()
            .priorityFeeLowerCoefficient(200L) // Min reward = Wei.One * 200L / 100 = 2.0
            .priorityFeeUpperCoefficient(500L)
