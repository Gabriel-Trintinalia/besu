...
public class EthCallTest {
  ...
  public void someStateOverrides() {
    ...
    Optional<StateOverrides> maybeStateOverrides = method.getStateOverrides(request);
    assertThat(maybeStateOverrides.isPresent()).isTrue();
    StateOverrides overrideMap = maybeStateOverrides.get();
  ...
  private JsonRpcRequestContext ethCallRequestWithStateOverrides(
      ...
      final StateOverrides overrides) {
    return new JsonRpcRequestContext(
        new JsonRpcRequest(
