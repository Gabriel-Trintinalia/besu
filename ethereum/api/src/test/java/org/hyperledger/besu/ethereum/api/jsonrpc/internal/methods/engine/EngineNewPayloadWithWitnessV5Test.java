...
class EngineNewPayloadWithWitnessV5Test {
  ...
  @Test
  void buildPayloadResultEmitsStatusEvenWhenWitnessCannotBeBuilt() {
    ...
    final Object payload =
        method.buildPayloadResult(
            ExecutionEngineJsonRpcMethod.EngineStatus.VALID, header.getHash(), result);
  ...
  @Test
  void buildPayloadResultReturnsNullWitnessWhenParentHeaderMissing() {
  ...
  @Test
  void buildPayloadResultReturnsNullWitnessWhenBlockHeaderNotPersisted() {
