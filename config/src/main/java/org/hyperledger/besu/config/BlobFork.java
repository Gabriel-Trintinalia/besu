...
public class BlobFork {
  private final int target;
  private final int max;
  private final int baseFeeUpdateFraction;

  /** The constant CANCUN_DEFAULT. */
  public static final BlobFork CANCUN_DEFAULT = new BlobFork(3, 6, 3338477);

  /** The constant PRAGUE_DEFAULT. */
  public static final BlobFork PRAGUE_DEFAULT = new BlobFork(6, 9, 5007716);

  /** The constant OSAKA_DEFAULT. */
  public static final BlobFork OSAKA_DEFAULT = new BlobFork(9, 12, 5007716);

  /** The constant FUTURE_EIPS_DEFAULT. */
  public static final BlobFork FUTURE_EIPS_DEFAULT = OSAKA_DEFAULT;
   ...
   */
  public BlobFork(final ObjectNode blobScheduleConfigRoot) {
  ...
  BlobFork(final int target, final int max, final int baseFeeUpdateFraction) {
    this.target = target;
    this.max = max;
   ...
   */
  public long getBaseFeeUpdateFraction() {
