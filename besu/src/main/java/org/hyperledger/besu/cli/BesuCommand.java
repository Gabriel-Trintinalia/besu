...
import org.hyperledger.besu.services.MinerServiceImpl;
...
public class BesuCommand implements DefaultCommandValues, Runnable {
  ...
  private void startPlugins(final Runner runner) {
    ...
    besuPluginContext.addService(MinerService.class, new MinerServiceImpl(besuController.getMiningCoordinator()));
